package seminar2.circles.view;

import seminar2.circles.exceptions.BallsOverflowException;
import seminar2.circles.sprites.Background;
import seminar2.circles.sprites.Ball;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler{
    ...
    private static final int DEFAULT_COUNT_SPRITES = 15;
